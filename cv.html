...
<body>
 <div class="col-md-offset-2 col-md-8" style="background: #E4E5E9" id="wrapper">
  <div id="header">
   <div>
    <img src="Capture.jpg" class="img-circle" id="image">
   </div>
   <div>
    <h2 id="name">Mamadou Ndiaye </h2>
    <p id="underline"></p>
    <h5 id="web">Developpeur Full Stack</h5>
   </div>
  </div><!--  end header -->
  <div class="row">
   <div class="col-md-12">
    ...
    <div id="experience">
     <div id="exp1">
      ...
      <div>
       <h4 id="ent">Enterprise</h4>
       <p >Experience is the knowledge or mastery of an event or subject gained through involvement in or exposure to it. Terms in philosophy such as "empirical knowledge" or "a posteriori knowledge" are used to refer to knowledge based on experience.</p>
      </div>
     </div> <!-- end section 1 -->
     <div id="exp1">
      <div>
   ...
   <div class="col-md-5">
    ...
    <div class="topM">
     <svg version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"viewBox="0 0 348.077 348.077">
      ...
      <span id="space"><a href="#">0333-4543212</a></span>
    </div>
    <div class="topM">
